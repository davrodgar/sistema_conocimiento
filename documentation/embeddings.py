"""
Este módulo procesa archivos de texto segmentándolos en párrafos.

Funciones principales:
- segmentar_en_parrafos: Divide un texto en párrafos basándose en reglas específicas.
- procesar_archivos_txt: Procesa todos los archivos .txt en un directorio 
    y guarda los resultados segmentados.
"""
